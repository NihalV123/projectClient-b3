...
import a123.vaidya.nihal.foodcrunchclient.ViewHolder.ShowCommentViewHolder;
...
public class ShowComment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView =(RecyclerView)findViewById(R.id.recycleer_comment);
        layoutManager = new LinearLayoutManager(this);
        recyclerView.setLayoutManager(layoutManager);

        //swipe layout init
        swipeRefreshLayout =(SwipeRefreshLayout)findViewById(R.id.shwocommentswipe);
